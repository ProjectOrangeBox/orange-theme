<?php pear::plugins('confirm_dialog,flash_msg,form_tools,input_mask,keymaster,rest_form,select3,table_sticky_header,tab_save,table_search_field,table_sort') ?>
